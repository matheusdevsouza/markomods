    ...
    return (
      <div className="flex justify-center items-center h-screen">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Carregando logs do sistema...</p>
        </div>
      </div>
    );
  }
            ...
            {filteredLogs.length === 0 ? (
              ...
              filteredLogs.map((log) => (
                <motion.div
                  ...
                  className="p-4 bg-muted/30 rounded-lg border border-border/50 hover:bg-muted/50 transition-all duration-200"
                >
