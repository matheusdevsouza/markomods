          ...
          <div className="max-w-6xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Skeleton className="h-6 w-96 bg-gradient-to-r from-gray-700 to-gray-600" />
              </div>
              
              {/* Grid skeleton */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <Skeleton key={i} className="h-80 w-full bg-gradient-to-r from-gray-700 to-gray-600" />
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <Card className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardHeader>
                <CardTitle className="text-2xl font-minecraft text-primary">Erro ao Carregar Favoritos</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-4xl font-minecraft text-primary mb-2">
                  <Heart className="inline-block h-7 w-7 text-red-500 mr-2 align-[-2px]" />
                  Meus Favoritos
                </h1>
              ...
              <Button asChild variant="outline" className="text-primary hover:!text-primary hover:bg-primary/10 hover:border-primary/50">
                <Link to="/mods">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  <input
                    ...
                    className="w-full rounded-md bg-muted/30 border border-border/40 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary/40"
                  />
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="inline-flex rounded-md border border-border/40 overflow-hidden">
                    <button
                      ...
                      className={`px-3 py-2 text-sm transition-colors ${'all'===contentType ? 'bg-primary text-primary-foreground' : 'bg-muted/20 text-foreground hover:bg-muted/30'}`}
                    >Todos</button>
                    <button
                      type="button"
                      onClick={() => setContentType('mods')}
                      className={`px-3 py-2 text-sm transition-colors ${'mods'===contentType ? 'bg-primary text-primary-foreground' : 'bg-muted/20 text-foreground hover:bg-muted/30'}`}
                    >Mods</button>
                    <button
                      type="button"
                      onClick={() => setContentType('addons')}
                      className={`px-3 py-2 text-sm transition-colors ${'addons'===contentType ? 'bg-primary text-primary-foreground' : 'bg-muted/20 text-foreground hover:bg-muted/30'}`}
                    >Addons</button>
                  </div>
                </div>
                ...
                <div>
                  <Select value={version} onValueChange={setVersion}>
                    <SelectTrigger className="w-full bg-muted/30 border border-border/40">
